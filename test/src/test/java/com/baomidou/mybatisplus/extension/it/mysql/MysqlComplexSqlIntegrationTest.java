...
class MysqlComplexSqlIntegrationTest extends MysqlIntegrationTestBase {

    @Test
    void selectFuncCaseAndScalarSubQueryMapToDto() {
    ...
    @Test
    void joinGroupHavingAndAggregateFunctionsReturnExpectedStats() {
    ...
    @Test
    void subQueryWhereExistsNotExistsInAndDerivedJoinAreExecutable() {
    ...
    @Test
    void pageJoinAndPageGroupCoverDocsPaginationShapes() {
