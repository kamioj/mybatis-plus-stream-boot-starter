...
class DmWriteAndSoftDeleteIntegrationTest extends DmIntegrationTestBase {

    @Test
    void saveBatchDuplicateIgnoreAndReplaceUseDamengMergeModes() {
        ...
        assertEquals("Frank", userService.get(where -> where.eq(MysqlUserDo::getId, 10L)).getUsername());
    ...
    @Test
    void executableStreamUpdateEntityUpdateJoinAndDeleteCoverWriteDocsOnDameng() {
    ...
    @Test
    void logicalDeleteDefaultFilterWithDeletedAndRestoreFlowOnDameng() {
