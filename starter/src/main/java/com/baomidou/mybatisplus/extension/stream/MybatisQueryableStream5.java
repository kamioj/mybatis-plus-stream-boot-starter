...
public class MybatisQueryableStream5<T, R1, R2, R3, R4, R5> extends MybatisQueryableStream<T, MapKey5<R1, R2, R3, R4, R5>, MybatisQueryableStream5<T, R1, R2, R3, R4, R5>> {
    ...
    public MybatisQueryableStream5(Class<T> entityClass, StreamBaseMapper<T> baseMapper, Type... renameClass) {
        super(entityClass, baseMapper, renameClass);
    }

    public MybatisQueryableStream5(ExQueryWrapper<T> queryWrapper, Class<T> entityClass, StreamBaseMapper<T> baseMapper, Type... renameClass) {
        super(queryWrapper, entityClass, baseMapper, renameClass);
    }

    public MybatisQueryableStream5(Class<T> entityClass, StreamBaseMapper<T> baseMapper, TypeReference<?>... renameType) {
        super(entityClass, baseMapper, renameType);
    }

    public MybatisQueryableStream5(ExQueryWrapper<T> queryWrapper, Class<T> entityClass, StreamBaseMapper<T> baseMapper, TypeReference<?>... renameType) {
    ...
    public <R> MybatisQueryableStream5<T, R1, R2, R3, R4, R> map(Consumer<SelectLambdaQueryWrapper<R>> select, Class<R> renameClass) {
        ...
        return new MybatisQueryableStream5<>(queryWrapper, entityClass, baseMapper, copyRenameWithLast(renameClass));
    }
    ...
    public <R> MybatisQueryableStream5<T, R1, R2, R3, R4, R> map(Consumer<SelectLambdaQueryWrapper<R>> select, TypeReference<R> renameTypeReference) {
        ...
        return new MybatisQueryableStream5<>(queryWrapper, entityClass, baseMapper, copyRenameWithLast(renameTypeReference.getRawType()));
    }
    ...
    public <V> MybatisQueryableStream5<T, R1, R2, R3, R4, V> mapToValue(Function<GroupFunctionLambdaQueryWrapper, V> selectFunc) {
        ...
        return new MybatisQueryableStream5<>(queryWrapper, entityClass, baseMapper, copyRenameWithLast(Object.class));
    }
    ...
    public <R, V> MybatisQueryableStream5<T, R1, R2, R3, R4, V> mapToColumn(SFunction<R, V> selectColumn, String rename) {
        ...
        return new MybatisQueryableStream5<>(queryWrapper, entityClass, baseMapper,
