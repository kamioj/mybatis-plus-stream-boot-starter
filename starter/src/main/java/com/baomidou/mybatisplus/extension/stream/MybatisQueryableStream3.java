...
public class MybatisQueryableStream3<T, R1, R2, R3> extends MybatisQueryableStream<T, MapKey3<R1, R2, R3>, MybatisQueryableStream3<T, R1, R2, R3>> {
    ...
    public MybatisQueryableStream3(Class<T> entityClass, StreamBaseMapper<T> baseMapper, Type... renameClass) {
        super(entityClass, baseMapper, renameClass);
    }

    public MybatisQueryableStream3(ExQueryWrapper<T> queryWrapper, Class<T> entityClass, StreamBaseMapper<T> baseMapper, Type... renameClass) {
        super(queryWrapper, entityClass, baseMapper, renameClass);
    }

    public MybatisQueryableStream3(Class<T> entityClass, StreamBaseMapper<T> baseMapper, TypeReference<?>... renameType) {
        super(entityClass, baseMapper, renameType);
    }

    public MybatisQueryableStream3(ExQueryWrapper<T> queryWrapper, Class<T> entityClass, StreamBaseMapper<T> baseMapper, TypeReference<?>... renameType) {
    ...
    public <R> MybatisQueryableStream3<T, R1, R2, R> map(Consumer<SelectLambdaQueryWrapper<R>> select, Class<R> renameClass) {
        ...
        return new MybatisQueryableStream3<>(queryWrapper, entityClass, baseMapper, copyRenameWithLast(renameClass));
    }
    ...
    public <R> MybatisQueryableStream3<T, R1, R2, R> map(Consumer<SelectLambdaQueryWrapper<R>> select, TypeReference<R> renameTypeReference) {
        ...
        return new MybatisQueryableStream3<>(queryWrapper, entityClass, baseMapper, copyRenameWithLast(renameTypeReference.getRawType()));
    }
    ...
    public <V> MybatisQueryableStream3<T, R1, R2, V> mapToValue(Function<GroupFunctionLambdaQueryWrapper, V> selectFunc) {
        ...
        return new MybatisQueryableStream3<>(queryWrapper, entityClass, baseMapper, copyRenameWithLast(Object.class));
    }
    ...
    public <R, V> MybatisQueryableStream3<T, R1, R2, V> mapToColumn(SFunction<R, V> selectColumn, String rename) {
        ...
        return new MybatisQueryableStream3<>(queryWrapper, entityClass, baseMapper,
